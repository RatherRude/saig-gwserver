...
https://www.youtube.com/watch?v=g_hRSI4seEs

## This bundle contains:
*`externalMessage.php`: PHP file to interfaces Herika saig-gwserver (works as entry point for Twitch IRC Client and Botrix Crawler)
*`template.txt`: Template for bot messages(botrix) so the Node Server identifies them correctly
...
*Use markup from template.txt for message generation
